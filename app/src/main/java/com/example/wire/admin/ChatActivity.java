...
import com.example.wire.adapter.MessageAdapter;
import com.example.wire.databinding.ActivityChatBinding;
import com.example.wire.model.MessagesModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void loadUserDetails() {
        if (!Objects.equals(userId, "nAFegdLtsHeLvLLP5QQHMECXrue2")){
