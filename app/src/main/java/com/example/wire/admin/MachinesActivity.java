...
public class MachinesActivity extends AppCompatActivity {
    ActivityMachinesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMachinesBinding.inflate(getLayoutInflater());
    ...
    public void onResume() {
        ...
        dbRefMachines.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                Toast.makeText(MachinesActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
